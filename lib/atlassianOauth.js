...
cw_atlassian_oauthPassport.use(
  new OAuth1Strategy(
    {
      requestTokenURL: base_url + "/plugins/servlet/oauth/request-token",
      accessTokenURL: base_url + "/plugins/servlet/oauth/access-token",
      userAuthorizationURL: base_url + "/plugins/servlet/oauth/authorize",
      consumerKey: "incture",
      consumerSecret: jirapem,
